...
export default function SixthSection() {
    return (
        <div className='w-full flex lg:flex-row flex-col justify-center px-6 py-20 lg:px-14 items-center'>
            <div style={{border: '1px solid #00A0FF', borderRadius: '8px'}} className='w-full lg:h-36 py-6 lg:py-0 flex flex-col justify-center px-10 mx-1' >
            ...
            <div style={{border: '1px solid #00A0FF', borderRadius: '8px'}} className='w-full lg:h-36 py-6 lg:py-0 lg:mt-0 mt-10 flex flex-col justify-center px-10 mx-1' >
