...
export default function SendMessage() {
    return (
        <div className='w-full py-12 bg-[#F9FCFF] flex flex-col justify-center items-center' >
            ...
            <div className='lg:w-600px w-full lg:px-0 px-6' >
                <div className='w-full flex lg:flex-row flex-col items-center mt-12' > 
                    ...
                    <div className='lg:w-auto w-full mt-4 lg:mt-0 lg:mx-5' >
                        <p className='text-sm font-CircularStd-Regular mb-1 text-[#222]' >Phone</p>
                        <Input  size='lg' fontSize='sm' backgroundColor='#F4F4F4' placeholder=''  /> 
                    </div>
                    <div className='lg:w-auto w-full mt-4 lg:mt-0 ' >
                ...
                <Input className='w-full' size='lg' fontSize='sm' backgroundColor='#F4F4F4' placeholder=''  /> 
