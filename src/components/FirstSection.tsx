...
<<<<<<< HEAD
        <div className=' w-full flex flex-col lg:flex-row px-6 lg:px-14 py-20 relative' >
            <div className='w-full relative z-20' >
                ...
                <p className=' lg:w-505px my-4 lg:text-72 font-CircularStd-Regular' >Get the quickest and safest transportation and logistics services with Everest, Anytime and Anywhere<br/> Africa’s No.1 Mobility As A Service platform.</p>
