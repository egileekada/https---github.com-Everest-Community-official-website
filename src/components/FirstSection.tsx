...
export default function FirstSection() {
    return (
        <div className=' w-full flex px-14 py-20 relative' >
            <div className='w-full relative z-20' >
                <p className='text-5xl font-CircularStd-Medium lg:w-505px ' >Get a Ride Anytime and Anywhere</p>
                <p style={{color: '#727272'}} className=' lg:w-505px my-4 font-CircularStd-Regular' >Get the quickest and safest transportation and logistics services with Everest, Anytime and Anywhere Africa’s No.1 Mobility As A Service platform.</p>
                <div className='flex' >  
                    <button style={{backgroundColor: '#0B85FD', color: '#FFF'}} className='rounded-xl w-36 text-sm h-12' >Buy $EVR</button>
                    <button style={{backgroundColor: 'rgba(0, 160, 255, 0.08)', color: '#00A0FF'}} className='rounded-xl flex items-center w-auto px-5 ml-5 text-sm h-12' >
            ...
            <img src={Car} alt='car' className='absolute right-0 bottom-0' style={{width: '795px'}} /> 
        </div>
    )
}
