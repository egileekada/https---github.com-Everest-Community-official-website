...
=======
        <div
          ...
          className="relative w-full h-505px lg:h-auto"
        >
          {/* <img src={Header} className='object-cover'  alt='' /> */}
          <div className=" w-full flex justify-center px-6 lg:px-14 mt-auto pt-32 ">
            <div className="text-white">
              <p className="lg:text-4xl text-3xl font-CircularStd-Medium lg:w-505px ">
                Subscribe to Everest rides as an individual or as an organization
              </p>
              <p className=" lg:w-505px my-4 text-white font-CircularStd-Regular">
                Get group discounts when your company signs up. Your staff,
                stakeholders and tribe no longer need to pay when you give them
                your code. Harness a sharing culture.
              </p>
            </div>
            <div className="w-auto bg-white ml-6 hidden lg:flex text-black">
              {/* <div className='bg-blue-300 w-full' /> */}
              <div className="w-400px py-6 px-6 border-b border-black ">
                <p className="font-CircularStd-Medium text-xl">
                  Signup as an organization below
                </p>

                <div className="w-full">
                  <div className="flex mt-4">
                    <div className="mr-1 ">
                      <p className="font-CircularStd-Regular text-sm ">
                        Business Email
                      </p>
                      <Input
                        size="lg"
...
>>>>>>> ec5978f820e731f6c3007fc8a33e62a0c7c342aa
                  ...
                  <p className="font-CircularStd-Regular text-sm mt-4">
                    Country
                  </p>
                  <Select
                    size="lg"
                  ...
                  />
                  <button
                    style={{ backgroundColor: "#0B85FD", color: "#FFF" }}
                    className="rounded-xl w-full text-sm h-12 mt-8"
                  >
                    Next
                  </button>
                </div>
        ...
        <div className="w-auto bg-white lg:ml-6 mt-6 lg:hidden text-black">
          ...
          <div className=" w-full lg:w-400px py-6 px-6 lg:-mb-20">
            <p
              ...
              className="font-CircularStd-Medium text-xl"
            >
              Signup as an organization below
            </p>
